...
DEPLINT bksv_flag_count = 0;
DEPLINT hdcp_status = 0;
DEPLINT hdcp_enabled = 0;
DEPLINT hdcp_requested = 0;
DEPLINT bksv_flag_counter = 0;
DEPLINT bksv_count = 0;
DEPLINT total_bksvs = 0;
BYTE bksv[BKSV_MAX];
BYTE hdcp_bstatus[2];
void (*compare_bksvs_ptr)(BYTE *bksvs, DEPLINT bksv_count,BYTE *hdcp_bstatus);
#endif
...
{
    compare_bksvs_ptr = compare_bksvs;
    hdcp_requested = 1;
