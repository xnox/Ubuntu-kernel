...
struct ieee80211_quiet_info {
	int num_of_quiet_ies;
	struct ieee80211_quiet_ie ie[0];
};
/**
 ...
 * @BSS_CHANGED_QUIET: 802.11h quiet period(s) changed
 */
 ...
 * @quiet_conf: if quiet period is supported, this field represents the
 *              required quiet period(s) details. It is the driver's
 *              resposibility to free the memory held by this field.
 *              (specifically, the 'buf' field of this field should be freed)
 */
...
enum ieee80211_conf_flags {
	...
	IEEE80211_CONF_CHANNEL_SWITCH   = (1<<3),
};
