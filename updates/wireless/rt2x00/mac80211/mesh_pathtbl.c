...
/**
 * rt2x_mesh_plink_broken - deactivates paths and sends perr when a link breaks
 *
 ...
 */
void rt2x_mesh_plink_broken(struct sta_info *sta)
{
	struct mesh_path *mpath;
	struct mpath_node *node;
	struct hlist_node *p;
...
EXPORT_SYMBOL(rt2x_mesh_plink_broken);
