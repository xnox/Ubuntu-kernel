...
struct sta_info *rt2x_sta_info_get(struct ieee80211_local *local, u8 *addr)
{
	return __sta_info_find(local, addr);
}
EXPORT_SYMBOL(rt2x_sta_info_get);

struct sta_info *rt2x_sta_info_get_by_idx(struct ieee80211_local *local, int idx,
