...
#define DRV_VERSION "0.2.9.5" DRV_DEBUG
char e1000e_driver_name[] = "e1000e-ich9m";
...
static int e1000_request_irq(struct e1000_adapter *adapter)
{
	...
	err = request_irq(adapter->pdev->irq, (adapter->flags & FLAG_HAS_MSI) ?
