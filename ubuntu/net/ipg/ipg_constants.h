 ...
 * ipg_constants.h
 *
 * Include file with non-tunable constants for Gigabit Ethernet
 ...
 *
 * 0.2  8/13/01  Added GMII based PHY IDs and GMII_ID_1.
 *
 * 0.3  8/16/01  Added GMII_PHY_CONTROL_RESET.
 */
