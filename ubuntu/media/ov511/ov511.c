...
{
	video_device_create_file(vdev, &dev_attr_custom_id);
	video_device_create_file(vdev, &dev_attr_model);
	video_device_create_file(vdev, &dev_attr_bridge);
	video_device_create_file(vdev, &dev_attr_sensor);
	video_device_create_file(vdev, &dev_attr_brightness);
	video_device_create_file(vdev, &dev_attr_saturation);
	video_device_create_file(vdev, &dev_attr_contrast);
	video_device_create_file(vdev, &dev_attr_hue);
	video_device_create_file(vdev, &dev_attr_exposure);
}
