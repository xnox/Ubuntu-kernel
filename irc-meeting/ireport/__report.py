...
class HtmlReport(Report):
    ...
    def releaseMetricsBugs(self, metrics):
        ...
        self.w("-->")
        self.w('<h3 style="font-weight: bold;font-size:1.75em;border-bottom: 2px solid silver;">Release Metrics</h3>')
        self.w('<h3 style="font-weight: bold;font-size:1.5em;">Bugs</h3>')
        self.w('<table width="100%">')
        str = '    <tr>'
        for state in ['milestoned', 'targeted']:
            tmp = "<strong>%s</strong>" % metrics[state]['header']
            str += '<td width="25%%" align="center">%-60s</td>' % tmp
        str += '<td></td></tr>'
        self.w(str)

        str = '    <tr><td>linux</td>'
        for state in ['milestoned', 'targeted']:
            str += '<td width="25%%" align="center"> %-60s </td>' % (metrics[state]['value'])
        str += '<td></td></tr>'
        self.w(str)
        self.w("</table>")
        return
    ...
    def incomingBugsFinish(self, incoming, regressions):
        ...
        out('    <tr><td width="30">&nbsp;</td><td width="25%" align="center" style="border-spacing: 0; border-width: 0 1px 2px 0; border-style: solid; border-color: blue;"><b>Version</b></td> <td width="25%" align="center" style="border-spacing: 0; border-width: 0 0px 2px 0; border-style: solid; border-color: blue;"><b>Count</b></td><td></td></tr>')

        out('    <tr><td width="30">&nbsp;</td><td width="25%%" align="left"   style="border-spacing: 0; border-width: 0 1px 1px 0; border-style: solid; border-color: blue;">%-22s</td> <td width="25%%" align="center" style="border-spacing: 0; border-width: 0 0px 1px 0; border-style: solid; border-color: blue;">%-22s</td><td></td></tr>' % ('Maverick', incoming['Maverick']))
        out('    <tr><td width="30">&nbsp;</td><td width="25%%" align="left"   style="border-spacing: 0; border-width: 0 1px 0px 0; border-style: solid; border-color: blue;">%-22s</td> <td width="25%%" align="center" style="border-spacing: 0; border-width: 0 0px 0px 0; border-style: solid; border-color: blue;">%-22s</td><td></td></tr>' % ('Lucid', incoming['Lucid']))
        ...
        out('<table width="100%" cellspacing="0">')
        out('    <tr><td width="20%" align="center" style="border-spacing: 0; border-width: 0 1px 2px 0; border-style: solid; border-color: blue;"><b>Version</b></td> <td width="25%" align="center" style="border-spacing: 0; border-width: 0 1px 2px 0; border-style: solid; border-color: blue;"><b>Potential</b></td> <td width="25%" align="center" style="border-spacing: 0; border-width: 0 1px 2px 0; border-style: solid; border-color: blue;"><b>Update</b></td> <td width="25%" align="center" style="border-spacing: 0; border-width: 0 1px 2px 0; border-style: solid; border-color: blue;"><b>Release</b></td><td width="25%" align="center" style="border-spacing: 0; border-width: 0 0px 2px 0; border-style: solid; border-color: blue;"><b>Proposed</b></td></tr>')
        for v in ['maverick', 'lucid', 'karmic', 'jaunty']:
            str = '    <tr><td width="20%%" align="left" style="border-spacing: 0; border-width: 0 1px 1px 0; border-style: solid; border-color: blue;"> %-21s </td>' % v
            for state in ['potential', 'update', 'release', 'proposed']:
                if state == 'proposed':
                    if state in regressions[v]:
                        str += '    <td width="20%%" align="center" style="border-spacing: 0; border-width: 0 0px 1px 0; border-style: solid; border-color: blue;"> %-21s </td>' % regressions[v][state]
                    else:
                        str += '    <td width="20%" align="center" style="border-spacing: 0; border-width: 0 0px 1px 0; border-style: solid; border-color: blue;"> &nbsp; </td>'
                else:
                    if state in regressions[v]:
                        str += '    <td width="20%%" align="center" style="border-spacing: 0; border-width: 0 1px 1px 0; border-style: solid; border-color: blue;"> %-21s </td>' % regressions[v][state]
                    else:
                        str += '    <td width="20%" align="center" style="border-spacing: 0; border-width: 0 1px 1px 0; border-style: solid; border-color: blue;"> &nbsp; </td>'
            str += "<td></td></tr>"
            out(str)

        for v in ['hardy']:
            str = '    <tr><td width="20%%" align="left" style="border-spacing: 0; border-width: 0 1px 0px 0; border-style: solid; border-color: blue;"> %-21s </td>' % v
            for state in ['potential', 'update', 'release', 'proposed']:
                if state == 'proposed':
                    if state in regressions[v]:
                        str += '    <td width="20%%" align="center" style="border-spacing: 0; border-width: 0 0px 0px 0; border-style: solid; border-color: blue;"> %-21s </td>' % regressions[v][state]
                    else:
                        str += '    <td width="20%" align="center" style="border-spacing: 0; border-width: 0 0px 0px 0; border-style: solid; border-color: blue;"> &nbsp; </td>'
                else:
                    if state in regressions[v]:
                        str += '    <td width="20%%" align="center" style="border-spacing: 0; border-width: 0 1px 0px 0; border-style: solid; border-color: blue;"> %-21s </td>' % regressions[v][state]
                    else:
                        str += '    <td width="20%" align="center" style="border-spacing: 0; border-width: 0 1px 0px 0; border-style: solid; border-color: blue;"> &nbsp; </td>'
            str += "<td></td></tr>"
            out(str)
        out("</table>")
