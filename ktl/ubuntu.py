...
class Ubuntu:
    ...
    db = {
        '11.10' :
        {
            ...
            {
                'linux' : [ 'linux-meta' ],
                'linux-ti-omap4' : [ 'linux-meta-ti-omap4' ],
            },
            'derivative-packages' :
            {
        ...
        '11.04' :
        {
            ...
            'dependent-packages' :
            {
                'linux' : [ 'linux-meta', 'linux-backports-modules-2.6.38' ],
                'linux-ti-omap4' : [ 'linux-meta-ti-omap4' ],
            },
            'derivative-packages' :
            {
        ...
        '10.10' :
        {
            ...
            'dependent-packages' :
            {
                'linux' : [ 'linux-meta', 'linux-ports-meta', 'linux-backports-modules-2.6.35' ],
                'linux-ti-omap4' : [ 'linux-meta-ti-omap4' ],
                'linux-mvl-dove' : [ 'linux-meta-mvl-dove' ]
            },
            'derivative-packages' :
            {
        ...
        '10.04' :
        {
            ...
            'dependent-packages' :
            {
                'linux' : [ 'linux-meta', 'linux-ports-meta', 'linux-backports-modules-2.6.32' ],
                'linux-fsl-imx51' : [ 'linux-meta-fsl-imx51' ],
                'linux-mvl-dove' : [ 'linux-meta-mvl-dove' ],
                'linux-ec2' : [ 'linux-meta-ec2' ],
                'linux-lts-backport-natty' : [ 'linux-meta-lts-backport-natty' ],
                'linux-lts-backport-maverick' : [ 'linux-meta-lts-backport-maverick' ]
            },
            'derivative-packages' :
            {
            ...
            'backport-packages' :
            {
                ...
                'linux-lts-backport-natty' : [ 'linux', '10.10' ],
            },
